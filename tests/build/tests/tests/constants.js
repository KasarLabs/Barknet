...
exports.ERC20_CONTRACT = starknet_1.json.parse(fs_1.default.readFileSync("../.madara/cairo-contracts/ERC20.json").toString("ascii"));
exports.ERC721_CONTRACT = starknet_1.json.parse(fs_1.default.readFileSync("../.madara/cairo-contracts/ERC721.json").toString("ascii"));
exports.TEST_CONTRACT = starknet_1.json.parse(fs_1.default.readFileSync("../.madara/cairo-contracts/test.json").toString("ascii"));
exports.TEST_CAIRO_1_SIERRA = starknet_1.json.parse(fs_1.default
    .readFileSync("../.madara/cairo-contracts/HelloStarknet.sierra.json")
    .toString("ascii"));
exports.ERC20_CAIRO_1_SIERRA = starknet_1.json.parse(fs_1.default
    .readFileSync("../.madara/cairo-contracts/erc20.sierra.json")
    .toString("ascii"));
exports.TEST_CAIRO_1_CASM = starknet_1.json.parse(fs_1.default
    .readFileSync("../.madara/cairo-contracts/HelloStarknet.casm.json")
    .toString("ascii"));
exports.ERC20_CAIRO_1_CASM = starknet_1.json.parse(fs_1.default
    .readFileSync("../.madara/cairo-contracts/erc20.casm.json")
    .toString("ascii"));
